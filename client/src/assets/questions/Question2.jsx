...
const Question2 = () => {
    ...
    const fetchQuestion = async () => {
        const response = await fetch ("http://localhost:3000/question/2");
    ...
    return (
        <div className=" flex flex-col bg-[#FFF8E8] w-screen h-screen items-center">
            ...
            <div className="flex justify-center h-[150px] w-[700px] bg-[#458088] rounded-xl items-center text-white mt-[100px] font-medium font-style: italic text-xl text-center">
                {pregunta}
            </div>
